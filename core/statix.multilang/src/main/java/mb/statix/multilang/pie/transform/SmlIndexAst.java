...
public abstract class SmlIndexAst<E extends Exception> implements TaskDef<ResourceKey, Result<IStrategoTerm, ?>> {

    private final ITermFactory termFactory;
    private final Function<Supplier<String>, Result<IStrategoTerm, E>> parse;

    public SmlIndexAst(Provider<StrategoRuntime> strategoRuntimeProvider, Function<Supplier<String>, Result<IStrategoTerm, E>> parse) {
