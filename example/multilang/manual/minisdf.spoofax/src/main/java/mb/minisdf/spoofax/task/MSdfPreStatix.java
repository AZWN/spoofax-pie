...
public class MSdfPreStatix extends AstStrategoTransformTaskDef {
    @Inject public MSdfPreStatix(Provider<StrategoRuntime> strategoRuntimeProvider) {
        super(strategoRuntimeProvider, "pre-analyze");
    }
