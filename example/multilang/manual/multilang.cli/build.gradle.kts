...
application {
  mainClassName = "mb.multilang.cli.Main"
}

/* graal {
  graalVersion("19.2.0.1")

  mainClass("mb.multilang.cli.Main")
  outputName("tiger")
  option("--no-fallback")
  ...
  option("-H:IncludeResources=mb/multilang/target/.*") /* https://github.com/oracle/graal/blob/master/substratevm/RESOURCES.md */
